...
`}),r("p",null,[e[13]||(e[13]=n(" 接下来这段代码，是在计算元素是否属于“forbidden”节点，因为Vue不鼓励在模板内插入script或style，所以遇到这两种类型的情况会被打上forbidden的标志。相反的对于服务端渲染（SSR")),t(a,{id:3}),e[14]||(e[14]=n("）的情况，模板是整个html文档，而且其中的某个组件，所以难免要包含这两类元素，所以需要跳过这项检查。 "))]),t(l,{lang:"ts",path:"/src/compiler/parser/index.ts",lines:[206,207,"...",276],code:`if (isForbiddenTag(element) && !isServerRendering()) {

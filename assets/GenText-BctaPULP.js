import{E as n}from"./Emphasize-DU56A6mB.js";import{C as r}from"./CodeBlock-D4l11F0F.js";import{C as l}from"./CodeLine-BfNqZKSv.js";import{C as o}from"./CiteTo-D8xeIkKo.js";import{C as x}from"./Cite-vdwhptxl.js";import{r as f}from"./Index-DUed_7Vs.js";import{a as d,o as u,c as g,h as s,A as t,g as i,u as a,F as m}from"./index-CGPLEEhy.js";const k="<p>prefix {{ hyphen | toUpper }} suffix</p>",T=`// ast
{
  type: 1,
  tag: 'p',
  children: [
...
`,$=d({__name:"GenText",emits:["updateOutlineList"],setup(w,{emit:p}){return p("updateOutlineList",[{id:"#genText_parseText",title:"模板插值"},{id:"#genText_parseFilters",title:"过滤器"},{id:"#genText_demo",title:"解析示例"}]),(R,e)=>(u(),g(m,null,[s("p",null,[e[0]||(e[0]=t(" 我们在介绍文本内容回调函数时曾经提到过，最终解析到的文本内容会被")),i(n,{type:"warning",text:"parseText"}),e[1]||(e[1]=t("函数解析一次，用于处理其中可能存在的模板插值语法。这一章我们将介绍parseTest函数是如何处理插值语法，并最终生成文本节点渲染函数的。 "))]),e[44]||(e[44]=s("h5",{id:"genText_parseText"},"· 模板插值 ",-1)),s("p",null,[e[2]||(e[2]=t(" 在处理模板插值语法之前，首先需要确定模板插值语法的标识符，一般情况下标识符是两个连续的大括号，当然我们也可以在构建参数中自行设置，比如可以使用这段代码")),i(l,{code:"const options: CompilerOptions = { delimiters: ['${', '}'], ... }"}),e[3]||(e[3]=t("，将标识符设置的与模板字符串内的插值语法相同（此时开始标识符为")),i(l,{code:"${"}),e[4]||(e[4]=t("，结束标识符为")),i(l,{code:"}"}),e[5]||(e[5]=t("）。 "))]),s("p",null,[e[6]||(e[6]=t(" 因此这段代码首先对标识符中可能存在的特殊字符进行了一次转义（注意")),i(l,{code:"\\\\$&"}),e[7]||(e[7]=t("指的就是在匹配到的字符前面加上反斜杠），避免使用标识符进行正则匹配的时候，这些字符被当作正则表达式内的特殊语法，而非字符本身。 "))]),s("p",null,[e[8]||(e[8]=t(" 接下来这段代码进行了一次正则表达式的拼装，其中")),i(l,{code:".|\\\\n"}),e[9]||(e[9]=t("指的是匹配任意字符，与")),i(l,{code:"\\\\s|\\\\S"}),e[10]||(e[10]=t("作用相同，二者在源码中都有使用。因此最终生成的正则表达式可以看成是，先匹配开始标识符，再用非贪婪匹配模式匹配任意字符，直到匹配结束标识符为止。 "))]),i(r,{lang:"ts",path:"/src/compiler/parser/text-parser.ts",lines:[...a(f)(4,11),"...",23],code:`const defaultTagRE = /\\{\\{((?:.|\\r?\\n)+?)\\}\\}/g

...
`}),e[40]||(e[40]=o("h5",{id:"genFlow_genShow"},"· v-show渲染语句 ",-1)),o("p",null,[e[30]||(e[30]=t(" v-show语句虽然和v-if语句一样都可以控制是否显示节点，但是严格意义上来讲，v-show节点并不能算作流程控制节点，因为其并未控制节点的条件渲染或循环渲染，而只操作节点的样式（")),n(i,{type:"warning",text:"display: none;"}),e[31]||(e[31]=t("），从这一点来看v-show语句与v-cloak语句更相似。 "))]),e[41]||(e[41]=o("p",null," 我们在之前的文章中也介绍过，v-show和v-cloak语句在生成渲染语句的过程中，并未被转化，依然是放在指令列表中传递给虚拟DOM作为参数。这样做是可能是为了避免与虚拟DOM中的staticStyle、dynamicStyle参数冲突，所以需要在运行时再操作style。总而言之我们会在之后的文章中，将这两者作为指令参数一并介绍。 ",-1)),n(d,{list:["https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Operators/Conditional_operator"]})],64))}});export{O as default};

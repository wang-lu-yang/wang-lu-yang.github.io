import{d as f,r as b,o as g,c as v,w as o,a as C,b as V,F as k,e,t as w,_ as x,f as l,g as n}from"./index-CH-gbXXw.js";import{C as p}from"./CodeBlock-CPb5YU8v.js";import{C as d}from"./CodeLine-Oci4BOrS.js";import{F as m}from"./FilePath-DmbrAone.js";import{T as j}from"./Tips-D03TbBzm.js";const B=f({__name:"HyperLink",props:["href","type"],setup(r){return(u,y)=>{const a=b("el-link");return g(),v(a,{href:r.href,type:r.type||"primary",target:"_blank",rel:"noopener noreferrer"},{default:o(()=>[u.$slots.default?C(u.$slots,"default",{key:0},void 0,!0):(g(),V(k,{key:1},[e(w(r.href),1)],64))]),_:3},8,["href","type"])}}}),s=x(B,[["__scopeId","data-v-818aabf4"]]),L=`import { makeMap } from 'shared/util';
...
`}),n(j,{type:"warning"},{default:o(()=>[t[27]||(t[27]=e(" 如果pnpm装包时出现")),t[28]||(t[28]=l("b",null,"puppeteer",-1)),t[29]||(t[29]=e("长时间安装不上的情况，可以在 ")),n(m,{path:"package.json"}),t[30]||(t[30]=e(" 文件内删除掉puppeteer依赖，然后重新装包。这个依赖包主要用于单元测试，不影响我们分析源码。 "))]),_:1}),t[34]||(t[34]=l("h5",{id:"introduce_demo"},"· 运行示例 ",-1)),t[35]||(t[35]=l("p",null," 此时我们已经可以在debug.ts脚本内调试任意内容了，比如我们可以引入上文提到的makeMap函数，让它生成一个判断是否为内置标签的函数，然后运行这个函数打印出结果。 ",-1)),n(p,{lang:"ts",path:"/src/debug.ts",code:L}),t[36]||(t[36]=l("p",null," 最后我们会在接下来的文章中正式开始对Vue源码进行分析。另外需要着重说明的是，这本文档应当只用于学习交流，不应用于商业目的。如需转载或引用，请与作者联系。 ",-1))],64)}}});export{I as default};

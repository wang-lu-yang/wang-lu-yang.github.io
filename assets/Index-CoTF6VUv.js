...
`}),t[15]||(t[15]=e("h5",{id:"parse_demo"},"· 解析示例 ",-1)),t[16]||(t[16]=e("p",null," 这里我们尽量使用默认的构建参数，回调函数方面，我们不需要生成模板语法树，引起全部改成打印日志。运行以下代码，我们不难发现，parseHTML实际上就是根据模板内容和构建参数，解析出其中的开始标签、结束标签、文本内容等部分，并分别交给相应的回调函数进行处理。 ",-1)),r(o,{lang:"ts",path:"/src/verify.ts",code:`import {
  HTMLParserOptions,
  parseHTML

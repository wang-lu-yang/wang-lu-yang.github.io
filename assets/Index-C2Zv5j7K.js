import{A as l}from"./ArticleLink-BlyXJPKn.js";import{E as o}from"./Emphasize-Cc5f5tIQ.js";import{C as r}from"./CodeBlock-D--D6FcI.js";import{C as p}from"./CodeLine-ByIZr7CI.js";import{F as s}from"./FilePath-DDiJjbhI.js";import{a as m,o as u,c as g,h as i,A as e,g as n,F as v}from"./index-Crdjmx25.js";import"./Index-D8oX6gvM.js";const O=m({__name:"Index",emits:["updateOutlineList"],setup(x,{emit:d}){return d("updateOutlineList",[{id:"#genCode_index",title:"渲染函数示例"},{id:"#genCode_state",title:"渲染函数生成过程的状态管理"},{id:"#genCode_generate",title:"渲染函数生成函数"}]),(f,t)=>(u(),g(v,null,[i("p",null,[t[0]||(t[0]=e(" 从这一章开始我们将介绍如何根据语法树生成渲染函数。这部分功能主要是由")),n(s,{path:"/src/compiler/codegen/index.ts"}),t[1]||(t[1]=e(" 文件内的")),n(o,{type:"warning",text:"generate"}),t[2]||(t[2]=e("函数实现的。 "))]),t[52]||(t[52]=i("h5",{id:"genCode_index"},"· 渲染函数示例 ",-1)),t[53]||(t[53]=i("p",null," 这里我们还是以一段简单的代码，先来来了解一下究竟是什么是渲染函数，以及渲染函数的作用。 ",-1)),n(r,{lang:"ts",path:"/src/verify.ts",code:`import { CompilerOptions } from 'types/compiler';

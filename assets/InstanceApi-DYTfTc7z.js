...
`}),t[72]||(t[72]=o("h5",{id:"instanceApi_renderMixin"},"· 异步处理相关实例API ",-1)),t[73]||(t[73]=o("p",null," Vue中的$nextTick实例API，实际上与nextTick全局API，引用的是同一个函数，只不过实例API可以传递Vue实例，也就是说我们使用$nextTick方法时，提供的回调函数中可以直接通过this指针引用到当前Vue实例。 ",-1)),n(m,{list:["https://v2.cn.vuejs.org/v2/api/#template"]})],64))}});export{C as default};

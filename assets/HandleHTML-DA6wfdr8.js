import{F as T}from"./FilePath-CV3o0BDF.js";import{E as s}from"./Emphasize-DU56A6mB.js";import{C as l}from"./CodeBlock-D4l11F0F.js";import{C as d}from"./CodeLine-BfNqZKSv.js";import{C as a}from"./CiteTo-D8xeIkKo.js";import{C as w}from"./Cite-vdwhptxl.js";import{a as g,o as x,c as v,z as E,h as r,n as y,t as P,A as n,g as t,f as V,u as i,F as k}from"./index-CGPLEEhy.js";import{_ as b,r as o}from"./Index-DUed_7Vs.js";const C={class:"quote"},L={class:"quote-footer"},M=g({__name:"Quote",props:["from","href"],setup(m){const p=m,u=()=>{p.href&&window.open(p.href,"_blank","noopener noreferrer")};return(f,e)=>(x(),v("div",C,[E(f.$slots,"default",{title:"default"},void 0,!0),r("div",L,[r("span",{class:y(["quote-from",{"is-link":p.href}]),onClick:u},"-- "+P(p.from),3)])]))}}),H=b(M,[["__scopeId","data-v-2f16d6bd"]]),z=g({__name:"HandleHTML",emits:["updateOutlineList"],setup(m,{emit:p}){return p("updateOutlineList",[{id:"#handleHTML_start",title:"开始标签回调函数"},{id:"#handleHTML_end",title:"结束标签回调函数"},{id:"#handleHTML_text",title:"文本内容回调函数"},{id:"#handleHTML_comment",title:"注释内容回调函数"}]),(f,e)=>(x(),v(k,null,[e[45]||(e[45]=r("p",null," 既然我们要了解模板语法树是如何生成的，不妨让我们先从整体上看一下回调函数是如何工作的。这一章我们先抛开Vue语法，但从纯HTML静态模板的角度上，来看语法树是如何生成的。在之后的章节里我们再结合Vue语法，逐个了解相应的代码是如何被处理的。 ",-1)),r("p",null,[e[0]||(e[0]=n(" 首先我们要明白，Vue2的模板内有且只能有一个根节点。那么我们是否可以先通过回调函数start找到根节点（")),t(s,{type:"danger",text:"root"}),e[1]||(e[1]=n("），然后利用先进后出的堆栈（")),t(s,{type:"danger",text:"stack"}),e[2]||(e[2]=n("），遇到节点就压栈，节点结束就弹出，并把节点放入对应父节点（即堆栈内的上一个元素")),t(s,{type:"danger",text:"currentParent"}),e[3]||(e[3]=n("）的children列表。依此循环处理完所有的回调函数之后，那我们不就可以用一个根节点来代替整个模板内容了吗。答案当时是可以的，而且Vue源码内就是这样实现的。 "))]),e[46]||(e[46]=r("h5",{id:"handleHTML_start"},"· 开始标签回调函数 ",-1)),r("p",null,[t(s,{type:"danger",text:"start"}),e[4]||(e[4]=n("回调函数执行时，首先处理了元素的命名空间，这主要是为了避免元素的默认行为（比如title元素，在html内被用于定义文档的标题")),t(a,{id:1}),e[5]||(e[5]=n("，而在svg元素内则用于定义图形的描述性字符串")),t(a,{id:2}),e[6]||(e[6]=n("，为了避免svg内的title被当作文档标题处理，所以需要命名空间进行区分）。以下代码先用")),t(s,{type:"warning",text:"platformGetTagNamespace"}),e[7]||(e[7]=n("函数，判断元素是否属于svg或math类型的元素，这两类元素对应的节点都需要加上命名空间标记，然后在计算子节点的时候就会因为父节点有命名空间，所以也带上相应的命名空间，依次类推该元素，及其子元素、子元素的子元素等都会带上命名空间标记。 "))]),r("p",null,[e[8]||(e[8]=n(" 这段代码中还针对IE命名空间不完善的情况做了处理，比如说如果IE浏览器中使用了")),t(d,{code:"/^NS\\d+:/"}),e[9]||(e[9]=n("这种格式的命名空间前缀，可能会导致SVG渲染异常或者属性无法应用，因此IE浏览器下需要删除这些不规范的命名空间前缀。因为这本文档旨在讨论VUE的实现过程，为了不偏离主题，所以之后遇到这种针对特定浏览器的问题修复，我们将不再讨论。 "))]),t(l,{lang:"ts",path:"/src/compiler/parser/index.ts",start:227,code:`const ns =
...
`}),r("p",null,[e[13]||(e[13]=n(" 接下来这段代码，是在计算元素是否属于“forbidden”节点，因为Vue不鼓励在模板内插入script或style，所以遇到这两种类型的情况会被打上forbidden的标记。相反的对于服务器端渲染（SSR")),t(a,{id:3}),e[14]||(e[14]=n("）的情况，模板是整个html文档，而且其中的某个组件，所以难免要包含这两类元素，所以需要跳过这项检查。 "))]),t(l,{lang:"ts",path:"/src/compiler/parser/index.ts",lines:[206,207,"...",276],code:`if (isForbiddenTag(element) && !isServerRendering()) {
  element.forbidden = true
  // ...
}
`}),r("p",null,[e[15]||(e[15]=n(" 接下来是对节点的“预处理”，")),t(s,{type:"warning",text:"preTransforms"}),e[16]||(e[16]=n("是一个数组表示所有预处理时需要执行的函数，这些函数与后续需要在节点处理时、节点处理完毕后需要执行的函数一样，都是来由构建参数传入，来源于")),t(T,{path:"/src/platforms/web/compiler/modules/index.ts"}),e[17]||(e[17]=n("，主要用于处理class、style、以及表单model等信息。比如Vue中")),t(d,{code:"class"}),e[18]||(e[18]=n("和")),t(d,{code:":class"}),e[19]||(e[19]=n("可以同时使用，因此静态class和动态绑定的class需要分开存放，最终在生成dom元素时再合并成同一个。这一部分我们会在介绍相关内容时再详细说明。 "))]),t(l,{lang:"ts",path:"/src/compiler/parser/index.ts",start:278,code:`// apply pre-transforms
...
`},null,8,["lines"]),r("p",null,[e[37]||(e[37]=n(" 最后这段代码，是为了把文本内容插入到父节点的children列表中。但是在插入之前需要先判断一下文本内容中是否有插值语法，这种情况与静态文本不同，需要根据变量动态的生成文本，所以需要单独生成一个表达式类型的节点。")),t(s,{type:"warning",text:"parseText"}),e[38]||(e[38]=n("函数如何将插值语法转化为表达式，我们会在之后的文章中单独讨论。这里我们只需要了解以下代码中，只要不是在v-pre节点下，且文本内容不为空，就会尝试用parseText函数将其转化为表达式，包含插值语法则能转化成功，就生成表达式节点，不包含插值语法则转化为空，就按普通文本处理。 "))]),r("p",null,[e[39]||(e[39]=n(" 对于普通文本，以下代码又做了三个条件判断进行过滤，其中")),t(d,{code:"text !== ' '"}),e[40]||(e[40]=n("很容易理解；")),t(d,{code:"!children.length"}),e[41]||(e[41]=n("则表示构建参数为preserve时，要保留开始标签到第一个到内容部分第一个词法单元之间的空格；")),t(d,{code:"children[children.length - 1].text !== ' '"}),e[42]||(e[42]=n("则是为了进行过滤，比如模板中因为注释的存在，连续的空白字符被分割成了两部分，最终生成两个空格，但是构建参数中又要求不保留注释，那为了避免这两个空格又形成新的连续的空白字符，所以要过滤到后一个空格。 "))]),t(l,{lang:"ts",path:"/src/compiler/parser/index.ts",lines:[...i(o)(376,395),"...",400,401],code:`let res
...
`},null,8,["lines"]),e[59]||(e[59]=r("h5",{id:"handleHTML_comment"},"· 注释内容回调函数 ",-1)),r("p",null,[t(s,{type:"danger",text:"comment"}),e[43]||(e[43]=n("回调函数内，处理节点的方式非常简单，就是生成一个子节点并插入当前父节点。注意这里注释对应的节点类型实际上与文本节点是一样的，只不过多了一个")),t(s,{type:"warning",text:"isComment"}),e[44]||(e[44]=n("变量加以区分。大部分场景下注释都不需要被保留，此时在模板解析函数里面遇到注释就会跳过，而不会执行这里的回调函数。 "))]),t(l,{lang:"ts",path:"/src/compiler/parser/index.ts",lines:[...i(o)(408,413),"...",...i(o)(418,419)],code:`if (currentParent) {
  const child: ASTText = {
    type: 3,
    text,
    isComment: true
...
`},null,8,["lines"]),t(w,{list:["https://developer.mozilla.org/zh-CN/docs/Web/HTML/Element/title","https://developer.mozilla.org/zh-CN/docs/Web/SVG/Element/title","https://v2.cn.vuejs.org/v2/guide/ssr.html","https://developer.mozilla.org/zh-CN/docs/Web/API/Document_Object_Model/Whitespace","https://en.wikipedia.org/wiki/Non-breaking_space"]})],64))}});export{z as default};

import{_ as d}from"./指令-OR9VwLml.js";import{r as i}from"./Index-DUed_7Vs.js";import{A as u}from"./ArticleLink-BU_R186K.js";import{E as s}from"./Emphasize-DU56A6mB.js";import{C as l}from"./CodeBlock-D4l11F0F.js";import{C as p}from"./CodeLine-BfNqZKSv.js";import{F as o}from"./FilePath-CV3o0BDF.js";import{C as v}from"./CiteTo-D8xeIkKo.js";import{C as g}from"./Cite-vdwhptxl.js";import{T as y}from"./Tips-CPGXbHE2.js";import{a as f,o as A,c as b,h as r,A as e,g as n,f as x,u as a,F as w}from"./index-CGPLEEhy.js";const B=f({__name:"ProcessAttrs",emits:["updateOutlineList"],setup(E,{emit:m}){return m("updateOutlineList",[{id:"#processAttrs_overview",title:"各种类型的“属性”"},{id:"#processAttrs_setAttrs",title:"如何生成节点属性"},{id:"#processAttrs_processAttrs",title:"属性“加工”"}]),(D,t)=>(A(),b(w,null,[t[56]||(t[56]=r("p",null," 这篇文章我们将介绍语法树中是如何处理元素属性的，包括如何识别出v-指令，以及对于特定的v-指令，比如v-bind，如何识别出需要将属性值绑定到一个动态的属性名，还是将属性值绑定给特定的属性值；或者v-on语句，如何识别出其修饰符等等，这对于后续通过v-指令生成对应结构的语法树至关重要。 ",-1)),t[57]||(t[57]=r("h5",{id:"processAttrs_overview"},"· 各种类型的“属性” ",-1)),r("p",null,[t[0]||(t[0]=e(" 我们从语法树类型定义中可以看出（参考文件")),n(o,{path:"/src/types/compiler.ts"}),t[1]||(t[1]=e("），节点内有多个存放属性的变量。为社么需要这么多变量，它们都是做什么用的？实际上这些变量可以归总如下： "))]),r("ol",null,[r("li",null,[n(s,{type:"danger",text:"attrsList"}),t[2]||(t[2]=e("这个值记录的是模板解析函数中传递的，最原始的属性。后续生成v-if、v-for、v-slot语法树的时候，会从这个列表内逐一删除对应的属性，以免被重复处理。 "))]),r("li",null,[n(s,{type:"danger",text:"attrsMap"}),t[3]||(t[3]=e("这个值就是根据attrsList将列表转化为以属性名和属性值为键值对的对象存储的，目的是为了方便后续通过属性名快速的找到对应的属性值，这在后续生成代码的过程中非常有用， "))]),r("li",null,[n(s,{type:"danger",text:"rawAttrsMap"}),t[4]||(t[4]=e("这个值是专用于抛出错误时定位到具体的属性的，其本质上存储的也是attrsList，只不过是将属性名作为键值方便后续查找。 "))]),r("li",null,[n(s,{type:"danger",text:"attrs"}),t[5]||(t[5]=e("这个值是专门用于存放节点中静态属性的，也就是属性名是固定值的情况，包括HTML中的原始属性，以及v-指令绑定具体某个属性的情况。 "))]),r("li",null,[n(s,{type:"danger",text:"dynamicAttrs"}),t[6]||(t[6]=e("这个值是专门用于存放节点中动态属性的，也就是属性名不固定（通过变量指定）的情况，也即v-指令中的动态属性。 "))])]),r("p",null,[t[7]||(t[7]=e(" 此外模板语法中的属性，还有可能存在于")),n(s,{type:"danger",text:"props"}),t[8]||(t[8]=e("、")),n(s,{type:"danger",text:"events"}),t[9]||(t[9]=e("、")),n(s,{type:"danger",text:"directives"}),t[10]||(t[10]=e("等对象中。让我们用以下示例代码说明问题： "))]),n(l,{lang:"ts",path:"/src/debug.ts",code:`import { CompilerOptions } from 'types/compiler';
...
`}),t[61]||(t[61]=r("h5",{id:"processAttrs_processAttrs"},"· 属性“加工” ",-1)),r("p",null,[t[26]||(t[26]=e(" 我们已经知道，模板解析回调函数在处理完节点之后（对于自闭和元素是在start回调函数的最后，对于普通元素则是在end回调函数的最后），会调用")),n(s,{type:"warning",text:"closeElement"}),t[27]||(t[27]=e("函数结束对于当前节点的处理。在这个结束函数中则会调用")),n(s,{type:"warning",text:"processElement"}),t[28]||(t[28]=e("，根据元素内可能存在的语法逐一进行“加工”，其中对于属性的加工，就是在这个函数的末尾，调用")),n(s,{type:"warning",text:"processAttrs"}),t[29]||(t[29]=e("函数进行的。 "))]),t[62]||(t[62]=r("p",null," 属性的加工过程，从整体结构上来看，就是对属性列表中的值逐一进行加工，如果判断出存在v-指令，则根据相应的语法，解析出对应的属性名、修饰符等。否则就作为一个普通的属性插入到节点当中。 ",-1)),n(l,{lang:"ts",path:"/src/compiler/parser/index.ts",lines:[...a(i)(32,34),"...",...a(i)(774,780),"...",895,"...",909,"...",...a(i)(919,921)],code:`export const dirRE = process.env.VBIND_PROP_SHORTHAND
  ? /^v-|^@|^:|^.|^#/
  : /^v-|^@|^:|^#/
// ...
...
`}),n(g,{list:["https://v2.cn.vuejs.org/v2/guide/syntax.html#%E6%A8%A1%E6%9D%BF%E8%AF%AD%E6%B3%95"]})],64))}});export{B as default};

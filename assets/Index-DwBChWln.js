import{E as i}from"./Emphasize-Cc5f5tIQ.js";import{C as p}from"./CodeBlock-D--D6FcI.js";import{C as l}from"./CodeLine-ByIZr7CI.js";import{F as o}from"./FilePath-DDiJjbhI.js";import{C as m}from"./CiteTo-FDG05ovd.js";import{C as d}from"./Cite-BGQKh001.js";import{r as u}from"./Index-D8oX6gvM.js";import{a as f,o as O,c as v,h as n,A as e,g as r,u as D,F as M}from"./index-Crdjmx25.js";const B=f({__name:"Index",emits:["updateOutlineList"],setup(a,{emit:s}){return s("updateOutlineList",[{id:"#runtime_verify",title:"调试过程示例"},{id:"#runtime_mount",title:"虚拟DOM挂载过程"}]),(w,t)=>(O(),v(M,null,[t[22]||(t[22]=n("p",null," 这一章我们将主要介绍运行时，如何从渲染函数生成虚拟DOM，虚拟DOM又是如何被挂载到真实DOM元素上的。为此我们需要重新整理一个调试过程，以便在函数操作真实DOM时，仍然能定位到具体操作。 ",-1)),t[23]||(t[23]=n("h5",{id:"runtime_verify"},"· 调试过程示例 ",-1)),n("p",null,[t[0]||(t[0]=e(" 首先我们需要放开源码中的")),r(i,{text:"full-dev"}),t[1]||(t[1]=e("构建配置，这样我们再运行")),r(l,{code:"npm run build"}),t[2]||(t[2]=e("时，我们写的调试语句会和源码一起，被放入")),r(o,{path:"/dist/vue.js"}),t[3]||(t[3]=e(" 文件中。 "))]),r(p,{lang:"js",path:"/scripts/config.js",lines:[34,"...",...D(u)(126,133),"...",233],code:`const builds = {
  // ...
  'full-dev': {
